...
def main(conf, args):
    train_set, val_set = dataloader.load_datasets(parser, args)
    ...
    conf["masknet"].update({"n_src": len(train_set.sources)})
    ...
    model = ConvTasNet(
        ...
        **conf["masknet"],
        ...
        audio_chan=conf["data"]["audio_chan"],
    )
    ...
    conf["data"].pop("sources")
    conf["data"].pop("source_augmentations")
